...
public class CloudBungeeHandler implements CloudSimpleHandler {
    ...
    public void enable(Plugin plugin) {
        ...
        try {
            this.manager = new BungeeCommandManager<>(
                    ...
                    /* Command Sender <-> C */ SenderMapper.create(this::getCommandSender, (sender) -> ((BungeeCommandSender) sender).getSender())
            );
    ...
    public CommandSender getCommandSender(net.md_5.bungee.api.CommandSender bungeeCommandSender) {
